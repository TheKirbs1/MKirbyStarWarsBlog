                ...
                <div className="card" style={{width: "14rem"}}>
                    ...
                    <div className="card-body">
                        ...
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item">Model: {store.VehicleDetails.properties.model}</li>
                            <li className="list-group-item">Vehicle Price: {store.VehicleDetails.properties.cost_in_credits}</li>
                        </ul>
                        <div>
                            <Link to ={`/people/${uid}`}>
